...
class CourseRepositoryInMemory {
   ...
   final List<Course> _courses = [
      ...
      const Course(
        ...
        description: 'Падежи, времена, склонения. Полный разбор грамматических правил с примерами.',
        rating: 4.7,
        author: 'Алина Техова',
        category: 'Популярное',
        urlPhoto: "https://ic.pics.livejournal.com/mg5642/66429722/1855716/1855716_original.jpg"
      ),
      const Course(
      ...
      const Course(
        ...
        description: 'Новые слова, интернет-лексика, молодежный сленг. Актуальные разговорные темы 2024-2025.',
        rating: 4.9,
      ...
      const Course(
        ...
        description: 'Как говорить на осетинском в интернете. Создание контента на родном языке.',
        rating: 4.8,
        author: 'Алан Гагиев',
        category: 'Новое',
        urlPhoto: "https://static.tildacdn.com/tild3362-3564-4366-a637-366263366537/IMG_0258-1.jpg"
      ),
      const Course(
        name: 'Деловой осетинский язык',
        description: 'Ведение переговоров, деловая переписка, официальные документы на осетинском.',
        rating: 4.7,
      ...
      const Course(
        ...
        description: 'Изучение дигорского диалекта. Отличия от иронского, особенности произношения.',
        rating: 4.8,
        author: 'Чермен Бестаев',
        category: 'Новое',
        urlPhoto: "https://vanlife-travel.ru/wp-content/uploads/2024/11/v-gorah-osetii-2048x1365.jpg"
      ),
      
      // ЛУЧШЕЕ
      const Course(
        name: 'Осетинский язык: от А до Я',
        description: 'Полный курс обучения с нуля до свободного владения. 100+ уроков, практика, тесты.',
        rating: 5.0,
      ...
      const Course(
        ...
        description: 'Изучение языка через нартский эпос, стихи Коста Хетагурова и современные тексты.',
        rating: 4.9,
      ...
      const Course(
        ...
        description: 'Интонации, акценты, разговорные обороты. Убираем акцент и говорим естественно.',
        rating: 4.9,
      ...
      const Course(
        ...
        description: 'Семейный курс. Игры, песни, диалоги для изучения языка всей семьей.',
        rating: 4.8,
        author: 'Марина Догузова',
        category: 'Лучшее',
        urlPhoto: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Vladikavkaz-014.jpg/1280px-Vladikavkaz-014.jpg"
      ),
    ];
